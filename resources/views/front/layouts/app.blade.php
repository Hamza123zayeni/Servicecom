...
<head>
	...
	<title>ServiceCom | Find Best Services</title>
...
<header>
	<nav class="navbar navbar-expand-lg navbar-light shadow py-3">
        ...
        <div class="logo-container">
          <div class="keyboard">
              <span class="key" id="service">S</span>
              <span class="key" id="service">e</span>
              <span class="key" id="service">r</span>
              <span class="key" id="service">v</span>
              <span class="key" id="service">i</span>
              <span class="key" id="service">c</span>
              <span class="key" id="service">e</span>              
              <span class="key" id="com">C</span>
              <span class="key" id="com">o</span>
              <span class="key" id="com">m</span>
          </div>
        </div>
      </a>
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<ul class="navbar-nav ms-0 ms-sm-0 me-auto mb-2 mb-lg-0 ms-lg-4" id="navitems">
					<li class="nav-item">
        ...
        @endif
				...
				<a class="btn btn-primary" href="{{ route('account.createService') }}" type="submit">Post a Service</a>
			</div>
		</div>
	</nav>
</header>
...
<div class="container">
    <p class="text-center text-white pt-3 fw-bold fs-6">© 2025 ServiceCom . all rights reserved</p>
</div>
</footer> 
